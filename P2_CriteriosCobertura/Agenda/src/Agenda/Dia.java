...
public class Dia {
	     ...
	     * @param duraci�n de la cita para la que se busca hueco
	    ...
	    {   int hora;    
	    	int slot = 0, sigSlot; // slot es posicion desde la que se busca tanto huecos libres seguidos como indica duraci�n
	    	while (slot < MAX_CITAS_POR_DIA){ 
	    		if(citas[slot] == null) {
	                ...
	                if(duracion == 1) {
	                	...
	                	sigSlot= slot + 1; // sigSlot empieza en la siguiente posici�n a slot y para recorriendo huecos libres
	    ...
	    /**
	     * String que devuelve la descripci�n de la cita asignada a la hora indicada.
	     */
	    ...
	    /**
	     * @return Numero de dia dentro del a�o (1-365).
	     */
	    ...
	    /**
	     * @param hora 
	     * @return true si la hora est� en el intervalo v�lido
	     *         false en otro caso.
	     */
	     ...
	     * @param duraci�n de la cita
	     * @return true si hay hueco libre a partir de la hora indicada y de la duraci�n requerida
	     *         false en otro caso.
	     */
