...
public class TestAgendaSemana {
	...
	public void testdiaSemana() throws DatoException {
		...
		assertEquals("No citable", s.diaSemana(0));
		assertEquals("Viernes", s.diaSemana(5));
		assertEquals("Jueves", s.diaSemana(4));
		assertEquals("Miercoles", s.diaSemana(3));
		assertEquals("Martes", s.diaSemana(2));
		assertEquals("Lunes", s.diaSemana(1));
	}
