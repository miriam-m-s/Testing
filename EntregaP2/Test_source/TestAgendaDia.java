...
public class TestAgendaDia {
	...
	public void testBuscaSlot() throws DatoException {
		...
		Cita cita = new Cita ("Desayunar", 2);
		dia.asignarCita(9, cita);
		
		//Test 2
		assertEquals(11, dia.buscaSlot(2));
		
		Cita cita_ = new Cita ("Depore", 1);
		dia.asignarCita(12, cita_);
		
		Cita cita_1 = new Cita ("Comer", 3);
		dia.asignarCita(14, cita_1);
